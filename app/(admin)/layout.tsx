    ...
    <div className="min-h-screen bg-gray-50 flex flex-col md:flex-row font-sans">
      ...
      <aside className="w-full md:w-64 bg-white border-r border-gray-200 flex flex-col flex-shrink-0">
        ...
        <nav className="p-4 space-y-1 flex-1">
          ...
          <Link href="/admin/recompensas" className="flex items-center space-x-3 px-3 py-2.5 text-gray-600 hover:bg-gray-50 hover:text-blue-600 font-medium rounded-lg transition-colors">
